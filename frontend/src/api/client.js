...
async function request(path, options = {}) {
  ...
  if (!res.ok) {
    ...
    err.data = json.data; // supaya caller bisa cek err.data?.requiresVerification dst
    throw err;
  }
  return json;
}
...
export const quotaApi = { get: () => request('/quota') };
export const generateApi = { create: (payload) => request('/generate', { method: 'POST', body: JSON.stringify(payload) }) };
